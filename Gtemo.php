        ...
        <?php if (!empty($Temoignages)): ?>
            <?php foreach ($Temoignages as $Temoignage): ?>
                <tr class="border-b">
                    ...
                    <td class="py-2 px-12"><?php echo htmlspecialchars($Temoignage['Testimonial_Title']); ?></td>
                    <td class="py-2 px-12"><?php echo htmlspecialchars($Temoignage['comment']); ?></td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
                <td colspan="3" class="text-center py-2">No testimonials found.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
